...
\begin{flushleft}
  A T-shaped software engineer who loves working with low-level stuff up to building distributed systems. I am now deepening my speciality in the area of embedded linux and realtime systems development. With a \textit{can do} attitude, I always accept new challenge, adapt quickly, and strive to give real impact to the organization.
...
\begin{itemize}
  ...
  \resitem{\textbf{Programming Language:} C, C++, C\#, Go, Python, JavaScript, Shell Script}
  \resitem{\textbf{Real-Time OS:} Zephyr, ARM MbedOS, MicroC/OS-II, FreeRTOS, RT-Linux}
  \resitem{\textbf{Web Technology:} VueJs, .Net Core, ELK Stack, Socket.IO}
  \resitem{\textbf{Cross Platform:} Qt, Xamarin}
  \resitem{\textbf{Others:} Backend and network programming, Embedded Linux, Cloud Technology, Docker, Yocto, SQL}
...
\item Beginning Test Driven Development in C++ - Udemy, 2018
\item C++ for Programmers - Udacity, 2018
