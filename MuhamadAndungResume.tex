...
\begin{flushleft}
  A T-shaped engineer who has broad horizontal knowledge in information technology and software development with deep vertical knowledge in embedded systems and software. A highly technical person who speaks, loves to engage discussion with team members and clients to solve complex engineering problem. His current focus is utilizing his expertise to help enterprises developing and utilizing IoT as part of their digital transformation journey.
...
\begin{itemize}
  \item
    \ressubheading{Schlumberger}{Jakarta, Indonesia}{Industrial IoT Software Engineer - Full-time}{June 2022 - Present}
    \begin{itemize}
      \item Developing industrial IoT solutions for oil and gas upstream operations.
    \end{itemize}
  \item 
    \ressubheading{Blue Bird Group}{Jakarta, Indonesia}{IoT Software Lead - Full-time}{May 2021 - June 2022}
    \begin{itemize}
      \item Leading software development (4 software engineers) and operation of IoT devices deployed in 20K vehicles. 
      \item Developing embedded Android application utilizing Android Open Source Project (AOSP).
      \item Developing embedded firmware using RT-Thread RTOS targeting STM32 ARM Cortex-M3 using Keil MDK.
      \item Interfacing with car's CAN bus system to obtain critical vehicle information from various car manufacturers.
      \item Developing IoT control center with main functionality for Firmware Over The Air update (FOTA) and device management.
      \item Developing backend services using Go deployed as microservices in Kubernetes cluster managed by GCP.
    \end{itemize}
