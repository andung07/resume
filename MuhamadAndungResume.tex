...
\texttt{muam@kth.se} & Stockholm, Sweden \\
...
A T-Profile software engineer with a demonstrated history in delivering professional projects using various technology. I am passionate in writing software to build and integrate complex systems. My skills vary from working with low-level stuff up to building distributed systems. I adapt quickly to a new environment and deliver instant result expected by the organization.
...
\item {\bf Web Technology: } .Net Core MVC, LoopBack Node.js, SignalR, Vue.js
\item {\bf Database: } MongoDB, SQLServer
\item {\bf Other: } CMake, Make, QMake, Docker, Git, Doxygen,
