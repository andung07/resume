...
\begin{flushleft}
  A T-shaped engineer who has broad horizontal knowledge in information technology and application development with deep vertical knowledge in embedded systems and software. A very technical person who speaks, loves to engage discussion with team members and clients to solve complex engineering problem. With those under my belt, my current focus is helping enterprises developing and utilizing IoT as part of their digital transformation journey.
...
\begin{itemize}
  ...
  \resitem{\textbf{Real-Time OS:} Zephyr, ARM MbedOS, MicroC/OS-II, FreeRTOS, ESP IDF, RT-Thread, RT-Linux}
